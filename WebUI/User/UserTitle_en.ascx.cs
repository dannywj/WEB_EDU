...
public partial class User_UserTitle : System.Web.UI.UserControl
{
    ...
    protected void btnEnd_Click(object sender, EventArgs e)
    {
        ...
        Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "", "<script>window.location='Index_en.aspx';</script>");
    }
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        Response.Redirect("Login_en.aspx");
    }
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        Response.Redirect("Signup_en.aspx");
    }
}