<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileList_en.aspx.cs" Inherits="User_Article" %>
    ...
    <div class="D_Middle_Article1">
        <dl class="BG220">
            <div class="D_R210_2" style="border-bottom: solid 1px #dedede;">
                <dl>
                    <dt class="D_Red26"><a href="#" title="News">News</a></dt>
                    <dd class="D_ContentList">
                        ...
                        <ul class="L">
                            <asp:Repeater ID="Rpt_NewList" runat="server">
                                <ItemTemplate>
                                    <div class="">
                                        <img src="../Images/Article_common2.gif">&nbsp;<a href="ArticleView_en.aspx?typeId=<%#((Model.Article)Container.DataItem).Typeid %>&articleId=<%#((Model.Article)Container.DataItem).Id %>&language=<%#((Model.Article)Container.DataItem).Language %>"
                ...
                <dl class="Content_P5">
                    ...
                    <dd class="ArticleContent">
                        <p style="color:#cc0000; margin-top:-10px;">
                            &nbsp; &nbsp; &nbsp; File Name <span style="margin-right: 1px; float: right;">Update Time&nbsp;
                                &nbsp; </span>
                        </p>
                        <asp:Repeater ID="Rpt_list" runat="server" OnItemCommand="Rpt_list_ItemCommand">
                            <ItemTemplate>
                                <p>
                                    ...
                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="down" CommandArgument="<%#((Model.Article)Container.DataItem).Id %>"><%#((Model.Article)Container.DataItem).Title %></asp:LinkButton>
                                    <span style="margin-right: 1px; float: right;">
                                        <%#((Model.Article)Container.DataItem).AddDate.ToShortDateString() %>
                                    </span>
                                </p>
                            </ItemTemplate>
                        </asp:Repeater>
