<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeminarsList_en.aspx.cs" Inherits="User_Article" %>
        ...
        <dl class="BG220">
            ...
            <div class="D_L735">
                <dl class="Content_P5">
                   ...
                   <%--<p style="color:#cc0000; font-weight:bold; margin-left:10px;">Seminars</p> --%>
                    
                    
                     <div style="color:#cc0000; font-weight:bold; margin:0 auto; font-size:20px; display:block; margin-left:200px;">RUC Seminars</div> 
                    ...
                    <dd class="ArticleContent">
                        ...
                        <asp:Repeater ID="Rpt_list" runat="server">
                            ...
                            <img src="../Images/Article_common2.gif">
                                    <span style="font-weight:bold">     <%#((Model.Article)Container.DataItem).Title %></span>:
                                      <a style="color:#00039f;" href="<%#((Model.Article)Container.DataItem).FileURL %>"
                                 target="_blank"><%#((Model.Article)Container.DataItem).Content %></a> </p>
