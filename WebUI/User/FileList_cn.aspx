<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileList_cn.aspx.cs" Inherits="User_Article" %>
                    ...
                    <dd class="D_ContentList">
                        ...
                        <ul class="L">
                            <asp:Repeater ID="Rpt_NewList" runat="server">
                                <ItemTemplate>
                                    <div class="">
                                        <img src="../Images/Article_common2.gif">&nbsp;<a href="ArticleView_cn.aspx?typeId=<%#((Model.Article)Container.DataItem).Typeid %>&articleId=<%#((Model.Article)Container.DataItem).Id %>&language=<%#((Model.Article)Container.DataItem).Language %>"
                ...
                <dl class="Content_P5">
                    ...
                    <dd class="ArticleContent">
                        <p style="color:#cc0000; margin-top:-10px;">
                            &nbsp; &nbsp; &nbsp; 文件名称 <span style="margin-right: 1px; float: right;">更新时间&nbsp;
                                &nbsp; </span>
                        </p>
