<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeminarsList_cn.aspx.cs" Inherits="User_Article" %>
        ...
        <dl class="BG220">
            ...
            <div class="D_L735">
                <dl class="Content_P5">
                   ...
                   <%--<p style="color:#cc0000; font-weight:bold; margin-left:10px;">学术讲座</p> --%>
                    <div style="color:#cc0000; font-weight:bold; margin:0 auto; font-size:20px; margin-left:200px;">中国人民大学能源研究中心研讨会</div> 
