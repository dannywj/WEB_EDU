...
function GetPageList(t1,d1,p1,p2,p3,v1,m1,rt1)
{
    ...
    if(p1>1){
        ...
        if(m1==0){
            if(parseInt(p2)>1){
                temppage = "<img src=\"" + d1 + "images/first.gif\" style=\"cursor:hand;\" onclick=\"ShowDynaPage(" + t1 + ",1," + rt1 + ",'" + d1 + "','" + v1 + "');\">";
                temppage += " <img src=\"" + d1 + "images/prev.gif\" style=\"cursor:hand;\" onclick=\"ShowDynaPage(" + t1 + "," + (parseInt(p2)-1) + "," + rt1 + ",'" + d1 + "','" + v1 + "');\">";
            }else{
                temppage = "<img src=\"" + d1 + "images/first_d.gif\">";
                temppage += " <img src=\"" + d1 + "images/prev_d.gif\">";
            }
            var beginlog;
            var endlog;
            if(parseInt(p2)>5){
            ...
            if(parseInt(p2)<parseInt(p1)){
                temppage += "<img src=\"" + d1 + "images/next.gif\" style=\"cursor:hand;\" onclick=\"ShowDynaPage(" + t1 + "," + (parseInt(p2)+1) + "," + rt1 + ",'" + d1 + "','" + v1 + "');\">";
                temppage += " <img src=\"" + d1 + "images/end.gif\" style=\"cursor:hand;\" onclick=\"ShowDynaPage(" + t1 + "," + p1 + "," + rt1 + ",'" + d1 + "','" + v1 + "');\">";
            }else{
                temppage += "<img src=\"" + d1 + "images/next_d.gif\">";
                temppage += " <img src=\"" + d1 + "images/end_d.gif\">";
            }
        }else{
            if(parseInt(p2)>1){
                temppage = " <img src=\"" + d1 + "images/prev.gif\" style=\"cursor:hand;\" onclick=\"ShowDynaPage(" + t1 + "," + (parseInt(p2)-1) + "," + rt1 + ",'" + d1 + "','" + v1 + "');\">";
