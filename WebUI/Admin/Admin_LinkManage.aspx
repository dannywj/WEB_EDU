<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_LinkManage.aspx.cs" Inherits="Admin_Admin_UserManage" %>
    ...
    <asp:Repeater ID="Rpt_Article" runat="server" OnItemCommand="Rpt_Article_ItemCommand">
        <ItemTemplate>
            <div class="tr">
                ...
                <div class="t_begin" style="width: 20%">
               <%#((Model.Article)Container.DataItem).Title %>
                </div>
                <div class="t_begin" style="width: 25%">
                    <%#((Model.Article)Container.DataItem).Content.Length > 20 ? ((Model.Article)Container.DataItem).Content.Substring(0, 20)+"..." : ((Model.Article)Container.DataItem).Content%>
                    <a href="<%#((Model.Article)Container.DataItem).Content %>" target="_blank">查看</a>
                </div>
                <div class="t_begin" style="width: 15%">
                ...
                <div class="t_begin" style="width: 10%">
                    <a href="Admin_LinkUpdate.aspx?articleId=<%#((Model.Article)Container.DataItem).Id %>&lang=<%#((Model.Article)Container.DataItem).Language %>">修改</a>
                </div>
                <div class="t_end " style="width: 10%">
