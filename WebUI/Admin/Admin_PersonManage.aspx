<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_PersonManage.aspx.cs" Inherits="Admin_Admin_UserManage" %>
...
<body>
    ...
    <div class="th">
        ...
        <div class="t_begin" style="width: 30%">
           姓名/头像
    ...
    <asp:Repeater ID="Rpt_Article" runat="server" OnItemCommand="Rpt_Article_ItemCommand">
        <ItemTemplate>
            <div class="tr">
                ...
                <div class="t_begin" style="width: 30%">
                    <%#((Model.Person)Container.DataItem).Pname %> &nbsp;&nbsp;
             <a target="_blank" href=" <%#((Model.Person)Container.DataItem).FileURL %>"> 查看头像</a>
                </div>
                <div class="t_begin" style="width: 15%">
                   <%#((Model.Person)Container.DataItem).Zhicheng %>
                </div>
                <div class="t_begin" style="width: 15%">
                  <%#((Model.Person)Container.DataItem).Phone %>
                </div>

                <div class="t_begin" style="width: 15%">
                  <%#((Model.Person)Container.DataItem).Type.ToString()=="0"?"全职":"兼职" %>
                </div>
                <div class="t_begin" style="width: 10%">
                    <a href="Admin_PersonUpdate.aspx?personId=<%#((Model.Person)Container.DataItem).Id %>&lang=<%#((Model.Person)Container.DataItem).Language %>">修改</a>
                </div>
                <div class="t_end " style="width: 10%">
                    <asp:LinkButton ID="LinkButton_del" runat="server" CommandName="del" CommandArgument=" <%#((Model.Person)Container.DataItem).Id %>" OnClientClick="return confirm('确认删除？')">删除</asp:LinkButton>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
