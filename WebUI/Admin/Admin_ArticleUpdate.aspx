<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_ArticleUpdate.aspx.cs" Inherits="Admin_Admin_ArticleAdd" ValidateRequest="false" %>
    ...
    <div class="tr" style="height: 700px; width: 800px">
        ...
        <div class="t2" style="height: 650px;">
            <FTB:FreeTextBox ID="TextBox_content" runat="server" ToolbarStyleConfiguration="Office2003"
                Width="550px" Height="600px" Language="zh-CN">
            </FTB:FreeTextBox>
        </div>
    </div>
