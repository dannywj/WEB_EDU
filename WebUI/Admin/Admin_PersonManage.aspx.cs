...
public partial class Admin_Admin_UserManage : System.Web.UI.Page
{
    ...
    public void GetData()
    {
        ...
        if (HttpContext.Current.Session["Language"] != null)
        {
            list = DBTools.GetAllPersonList(HttpContext.Current.Session["Language"].ToString());
        ...
        else
        {
            ...
            list = DBTools.GetAllPersonList(ddlLanguage.SelectedItem.Value);
        }
    ...
    protected void ddlLanguage_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Admin_PersonManage.aspx");
    }
