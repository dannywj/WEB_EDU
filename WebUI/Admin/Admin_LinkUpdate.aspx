<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_LinkUpdate.aspx.cs" Inherits="Admin_Admin_ArticleAdd" ValidateRequest="false" %>
    ...
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        ...
        <div class="t2" style="text-align: left">
            <asp:DropDownList ID="ddlType" runat="server" Enabled="false">
                ...
                <asp:ListItem Text="中心人员" Value="3"></asp:ListItem>
                <asp:ListItem Text="学术讲座" Value="4"></asp:ListItem>
        ...
        <div class="t2" style="text-align: left">
            <asp:TextBox ID="txtAuthor" runat="server" Width="300px" Text=""></asp:TextBox>
        </div>
    </div>
