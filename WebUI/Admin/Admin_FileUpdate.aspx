<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_FileUpdate.aspx.cs" Inherits="Admin_Admin_ArticleAdd" ValidateRequest="false" %>
    ...
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
     ...
     <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        ...
        &nbsp;
            ...
            <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" /> 重新上传文件
        </div>
    </div>
