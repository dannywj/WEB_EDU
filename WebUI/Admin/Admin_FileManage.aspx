<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_FileManage.aspx.cs" Inherits="Admin_Admin_UserManage" %>
...
<body>
    ...
    <div class="th">
        ...
        <div class="t_begin" style="width: 45%">
            文件标题
        </div>
    ...
    <asp:Repeater ID="Rpt_Article" runat="server" OnItemCommand="Rpt_Article_ItemCommand">
        <ItemTemplate>
            <div class="tr">
                ...
                <div class="t_begin" style="width: 10%">
                    <a href="Admin_FileUpdate.aspx?articleId=<%#((Model.Article)Container.DataItem).Id %>&lang=<%#((Model.Article)Container.DataItem).Language %>">修改</a>
                </div>
                <div class="t_end " style="width: 10%">
