<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_PersonAdd.aspx.cs" Inherits="Admin_Admin_ArticleAdd" ValidateRequest="false" %>
...
<body>
    ...
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        ...
        <div class="t2" style="text-align: left">
            <asp:TextBox ID="txtTeacherURL" runat="server" Width="300px" Text="http://"></asp:TextBox>
        </div>
    </div>
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        <div class="t1">
        ...
        <div class="t2" style="text-align: left"><asp:TextBox ID="txtZhicheng" runat="server" Width="300px"></asp:TextBox>
        </div>
    </div>
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        <div class="t1">
    ...
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        ...
        <div class="t2" style="text-align: left">
            <asp:RadioButton GroupName="ptype" ID="radioType1" runat="server" Checked="true" />全职<asp:RadioButton GroupName="ptype"  ID="radioType2" runat="server" />兼职
        </div>
    </div>
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        <div class="t1">
    ...
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        ...
        <div class="t2" style="text-align: left">
           ...
           支持 jpg png gif bmp 格式文件 大小不超过2mb
        </div>
    </div>
