<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_ContactManage.aspx.cs" Inherits="Admin_Admin_ArticleAdd" ValidateRequest="false" %>
...
<body>
    ...
    <div class="end " style="border: none;">
        <asp:Button ID="Button_sure" runat="server" Text="更新地址" OnClick="Button_sure_Click"
            Width="90px" />
        </div>
