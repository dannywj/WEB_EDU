...
public partial class Admin_Admin_UserManage : System.Web.UI.Page
{
    ...
    public void GetData()
    {
        ...
        if (HttpContext.Current.Session["Language"]!=null)
        {
            list = DBTools.GetArticleByType(4, HttpContext.Current.Session["Language"].ToString());
       ...
       else
        {
            ...
            list = DBTools.GetArticleByType(4, ddlLanguage.SelectedItem.Value);
        }
    ...
    protected void ddlType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Admin_SeminarsManage.aspx");
    }
