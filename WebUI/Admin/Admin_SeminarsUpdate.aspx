<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_SeminarsUpdate.aspx.cs" Inherits="Admin_Admin_ArticleAdd" ValidateRequest="false" %>
...
<body>
    ...
    <div class="tr" style="border-top: solid 1px #dedede; width: 800px">
        ...
        <div class="t2" style="text-align: left">
            <asp:TextBox ID="txtContent" runat="server" Width="300px" Text=""></asp:TextBox>
        </div>
    </div>
