<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_ArticleManage.aspx.cs" Inherits="Admin_Admin_UserManage" %>
    ...
    <asp:Repeater ID="Rpt_Article" runat="server" OnItemCommand="Rpt_Article_ItemCommand">
        <ItemTemplate>
            <div class="tr">
                ...
                <div class="t_begin" style="width: 30%">
                    <%--        <%#((Model.Article)Container.DataItem).Title %>  --%>   <a target="_blank" href="../User/ArticleView_<%#((Model.Article)Container.DataItem).Language=="cn"?"cn":"en" %>.aspx?typeId=<%#((Model.Article)Container.DataItem).Typeid %>&articleId=<%#((Model.Article)Container.DataItem).Id %>&language=<%#((Model.Article)Container.DataItem).Language %>"><%#((Model.Article)Container.DataItem).Title %>    </a>
                </div>
                <div class="t_begin" style="width: 15%">
                    <%#((Model.Article)Container.DataItem).Author %>
                </div>
                <div class="t_begin" style="width: 15%">
                ...
                <div class="t_begin" style="width: 10%">
                    <a href="Admin_ArticleUpdate.aspx?articleId=<%#((Model.Article)Container.DataItem).Id %>&lang=<%#((Model.Article)Container.DataItem).Language %>">修改</a>
                </div>
                <div class="t_end " style="width: 10%">
